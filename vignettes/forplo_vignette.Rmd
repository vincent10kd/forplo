...
#### TODOs ######
# * convert grouping var to factor before coercing to numeric, currently fails with character vectors
# * get rid of error message for zero-length arrows
# * make extrafont a depend and first load fonts
# * add readable error message for when character matrix/df is entered as mat
# * alternatively, convert to numeric
# * make sure that duplicate rownames/row.labels do not lead to issues
# * add readable error message for when CI columns are swapped
# * check that lower CI < upper bound, if not trigger error and stop
# * exception: all CIs are the same and estimate as well. Then plot and suppress warnings.
#################
